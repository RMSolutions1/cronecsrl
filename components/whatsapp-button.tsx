...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-[#25D366] px-4 py-4 text-white shadow-lg transition-all duration-300 hover:bg-[#128C7E] hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 md:bottom-8 md:right-8"
    ...
    >
      ...
      <span
        className={`hidden whitespace-nowrap text-sm font-medium transition-all duration-300 md:inline-block ${
