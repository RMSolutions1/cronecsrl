...
export default function ContactoPage() {
  ...
  useEffect(() => {
    Promise.all([getCompanyInfo(), getServicesPublic()]).then(([settings, servicesFromDb]) => {
      ...
      if (servicesFromDb?.length) {
        const list = servicesFromDb.map((s) => (s.title as string) || "").filter(Boolean)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Con Node/BD: enviar al API (solo en build con servidor)
    try {
      ...
      if (res.ok && result.success) {
        setSubmitStatus({ type: "success", message: result.message ?? "Gracias por contactarnos." })
        setTimeout(() => {
          setFormData({ nombre: "", empresa: "", email: "", telefono: "", servicio: "", mensaje: "" })
          setSubmitStatus(null)
        }, 3000)
      ...
      setIsSubmitting(false)
      setSubmitStatus({ type: "error", message: "Error de conexión. Intente más tarde o contáctenos por teléfono." })
    }
  }
    ...
    <>
      ...
      <main>
        ...
        <HeroCarousel
          ...
          subtitle="Estamos listos para asesorarlo y convertir su visión en realidad. Comuníquese con nosotros y descubra cómo podemos ayudarlo."
              ...
              {contactInfo.map((info, index) => {
                ...
                return (
                  <Card key={index} className="text-center hover:shadow-lg transition-all duration-300">
                    <CardHeader>
                      <div
                        className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-primary/10 mx-auto mb-3"
                        aria-hidden="true"
                      >
              ...
              <div>
                <div className="mb-8">
                  <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">
                    Solicite una <span className="text-primary">Cotización</span>
                  </h2>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Complete el formulario y nuestro equipo se comunicará con usted en menos de 24 horas.
                  </p>
                </div>
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            ...
                            required
                          >
                            <SelectTrigger id="servicio" aria-required="true">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <a href="tel:+5493875361210" className="text-sm text-primary hover:underline">
                        +54 9 (387) 536-1210
                      </a>
                    </div>
                    ...
                    <div className="border-t pt-4">
                      ...
                      <div className="flex items-center gap-3">
                        <a
                          href="#"
                          className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-primary/10 hover:bg-primary hover:text-primary-foreground transition-colors"
                          aria-label="Facebook de CRONEC SRL"
                        >
                        ...
                        <a
                          href="#"
                          className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-primary/10 hover:bg-primary hover:text-primary-foreground transition-colors"
                          aria-label="Instagram de CRONEC SRL"
                        >
                        ...
                        <a
                          href="#"
                          className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-primary/10 hover:bg-primary hover:text-primary-foreground transition-colors"
                          aria-label="LinkedIn de CRONEC SRL"
                        >
          ...
          <div className="container mx-auto px-4 md:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                {[
                  {
                    q: "¿Cuál es el tiempo de respuesta para una cotización?",
                    a: "Nuestro equipo comercial se comunica en menos de 24 horas hábiles para comenzar a evaluar su proyecto.",
                  },
                  {
                    q: "¿Trabajan en toda la provincia de Salta?",
                    a: "Sí, realizamos proyectos en toda la provincia de Salta y también en provincias vecinas del NOA.",
                  },
                  {
                    q: "¿Ofrecen garantías en sus trabajos?",
                    a: "Todos nuestros proyectos incluyen garantía según normativas vigentes, con soporte post-venta.",
                  },
                  {
                    q: "¿Puedo visitar una obra en ejecución?",
                    a: "Sí, coordinando previamente con nuestro equipo técnico para garantizar la seguridad.",
                  },
                ].map((faq, index) => (
                  <Card key={index}>
                    <CardHeader>
